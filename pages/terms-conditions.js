...
export default function TermsConditions() {
  ...
  const privacyPolicyTitle = 'Terms & Conditions';
  ...
  return (
    <div>
      <Layout title={privacyPolicyTitle} description={''}>
        <Grid
          direction="column"
          ...
          //   item
          container
          style={{ maxWidth: '800px', margin: '5vh 25px' }}
        >
          <h2 style={{ textAlign: 'center' }}>
            <b>TERMS AND CONDITIONS</b>
          </h2>
          <p>Last updated: 2023-01-28</p>
          <p>
            1. <b>Introduction</b>
          </p>
          <p>
            Welcome to <b>Al Nour Association</b> (“Company”, “we”, “our”,
            “us”)!
          </p>
          <p>
            These Terms of Service (“Terms”, “Terms of Service”) govern your use
            of our website located at <b>alnour-assoc.com</b> (together or
            individually “Service”) operated by <b>Al Nour Association</b>.
          </p>
          <p>
          ...
          <p>
            ...
            <b>info@alnour-assoc.com</b> so we can try to find a solution. These
          ...
          <p>
            ...
            emailing at info@alnour-assoc.com.
          </p>
          <p>
            3. <b>Purchases</b>
          </p>
          ...
          <p>
            We issue refunds for Contracts within <b>3 days</b> of the original
          ...
          <p>
            Content found on or through this Service are the property of Al Nour
            Association or used with permission. You may not distribute, modify,
          ...
          <p>
            ...
            property of Al Nour Association and its licensors. Service is
            ...
            product or service without the prior written consent of Al Nour
            Association.
          </p>
          <p>
          ...
          <p>
            ...
            email to info@alnour-assoc.com, with the subject line: “Copyright
          ...
          <p>
            You may provide us either directly at info@alnour-assoc.com or via
          ...
          <p>
            ...
            that are not owned or controlled by Al Nour Association.
          </p>
          <p>
            Al Nour Association has no control over, and assumes no
          ...
          <p>
            ...
            laws of Egypt, which governing law applies to agreement without
          ...
          <p>
            ...
            by email: <b>info@alnour-assoc.com</b>.
          </p>
          <p style={{ marginTop: '5em', fontSize: '0.7em' }}>
            ...
            were created for <b>alnour-assoc.com</b> by{' '}
            <a href="https://policymaker.io">PolicyMaker.io</a> on 2023-01-28.
          </p>
        </Grid>
      </Layout>
    </div>

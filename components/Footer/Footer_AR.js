    ...
    <div>
      ...
      >
        <div className={largeView ? 'footer-col1-ar' : 'footer-col1-ar-mobile'}>
          ...
          >
            شريكك المختص لادارة و توفير جميع أجهزة الطباعة و مستلزماتها من برامج
            أدارة المستخدمين و الأصول , و توفير الأحبار , و قطع الغيار <br />{' '}
            متخصصون في مؤسسة النور التجارية في توفير جميع أحتياجات المكاتب من
            أوراق الطباعة ومستلزمات المكاتب
            <br /> نبحث مع شركائنا علي توفير حلول فريدة لتوفير الوقت و التكاليف
            <br /> نعمل معا من أجل بيئة عمل أفضل
      ...
      <div className="footer-copyright-main-div">
        <Typography className="footer-copyright-text">
          {current.getFullYear()} | مؤسسة النور التجارية ©
        </Typography>
      </div>
    </div>
  );

...
export default function Home_AR() {
  ...
  const gridComponents = [
    {
      ...
      listIems: ['.الطباعة والنسخ والفاكس والمسح الضوئي', '.حل مخصص لشركتك', '.نحن نتكيف مع متطلباتك'],
      url: null,
      // gridBackground: '',
      // textColor: '',
    },
    {
      ...
      listIems: ['.حلول برامج إدارة المستندات الفعالة لسير العمل الخاص بك', '.تقليل استهلاك الورق والطاقة', '.تحكم كامل في مستنداتك الرقمية والمطبوعة'],
      url: null,
      // gridBackground: '',
      // textColor: '',
    },
    {
      ...
      listIems: ['.حلول مكتبية مريحة مدروسة بالكامل', '.المكاتب التنفيذية وقاعات الاجتماعات أو المنتجات الفردية', '.احتياجات مكتبية مجهزة تجهيزا كاملا'],
      url: null,
      // gridBackground: '',
      // textColor: '',
    },
    {
      ...
      listIems: ['.اعثر على جميع اللوازم المكتبية الخاصة بك في مكان واحد', '.تمزيق المستندات والملحقات والمواد الاستهلاكية'],
      url: null,
      // gridBackground: '',
      // textColor: '',
    },
    {
      ...
      listIems: ['.الخدمة هي أولويتنا القصوى', '.نحن نتميز بالتوافر الشخصي والموثوقية'],
      url: null,
      // gridBackground: '',
      // textColor: '',
    },
  ...
  const officePrintersParagraphs2 = [
    ...
    },
    {
      ...
      listItems: ['حلول الأجهزة', 'حلول البرمجيات', 'معدات المكتب', 'اللوازم المكتبية', 'الصيانة عن بعد', '48 ساعة للصيانة', 'مستهلكات', 'التدريب والدعم'],
    },
    {
      isBullet: false,
  ...
  const linkDescription2 = '.اعرف المزيد عن الأنظمة المتاحة. واكتشف الأجهزة التي تناسب متطلبات مكتبك بشكل أفضل';
